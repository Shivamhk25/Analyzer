...
import { getMostVisitNoPurchase } from "../../../API/analytic";
...
const MostRepeatVisitors = ({ date, rowItemCount }) => {
  ...
  const fetchMostVisitNoPurchase = async (data) => {
    try {
      const res = await getMostVisitNoPurchase(axiosFetch, data);
      console.log(res, "from fetchMostVisitNoPurchase");
      ...
      >
        ...
        >
          ...
          <Title fontWeight="700" level={3}>
            Users with most visits but no purchase
          </Title>
        </div>
