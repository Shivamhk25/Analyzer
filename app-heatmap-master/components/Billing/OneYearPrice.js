...
import { discountFun } from "./SixMonthPrice";
import MyNewSlider from "./MyNewSlider";
import { Tooltip } from "@chakra-ui/react";
import { IconContext } from "react-icons";
import { FiAlertCircle } from "react-icons/fi";
import { appName } from "./MonthlyPrice";
...
const OneYearPrice = ({ currentPlan }) => {
  ...
  // billing?charge_id=23458611405

  const getBilling = async () => {
    const chargeId = router.query.charge_id;
    console.log(chargeId, "inside get billing");
    ...
    let body = {
      data: {
        recurring_application_charge: {
          name: finalPlan,
          price: Math.round((finalPrice * 12 + Number.EPSILON) * 100) / 100,
          // test: true,
      ...
      <div>
        ...
        >
          ...
          >
            ...
            <Box height="230px" bg="" w="300px" mt={5}>
              ...
              {isVisible && (
                <>
                  <Text fontSize="15px" color="black" fontWeight="500">
                    ...
                    {Math.round((finalPrice * 12 + Number.EPSILON) * 100) / 100}
                  </Text>
                  <Button
                    // bg="blue"
                    background={"#b983ff"}
