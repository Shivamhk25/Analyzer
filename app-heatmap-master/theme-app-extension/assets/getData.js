const serverRecording = "https://heatmap.z08tech.com";
...
async function getIP() {
  var ipInfo;
  const res = await axios("https://ipinfo.io/json?token=32f7f063f4e13d");
  ipInfo = res?.data;
  return ipInfo;
}
...
async function getRecId() {
  axios
    .get(`${serverRecording}/shop/recording-id?shop=${RecordingShopName}`)
    .then((res) => {
